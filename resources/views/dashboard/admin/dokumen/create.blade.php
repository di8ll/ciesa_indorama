                                    ...
                                    <div class="tab-pane fade" id="barang" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input class="form-control" type="text" name="bruto[]" id="bruto2"  value="{{ old('bruto', 0) }}" >
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="netto2" name="netto[]"
                                    ...
                                    <div class="tab-pane fade" id="bahanBaku" role="tabpanel"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="cif3" name="cif[]"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control " id="ndpbm3"
                                                    name="ndpbm[]" value="{{ old('ndpbm', 16322) }}" >
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control " id="seriBarang2"
                                                    name="seriBarang[]" value="{{ old('seriBarang', 2) }}" >
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="seriBahanBaku2"
                                                    name="seriBahanBaku[]" value="{{ old('seriBahanBaku', 2) }}">
                                            </div>
                                            <div class="col-md-3">
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-md-3">
                                                 ...
                                                 <input type="text" class="form-control" id="jumlahSatuan4"
                                                     name="jumlahSatuan[]" value="{{ old('jumlahSatuan',2724.54) }}">
                                             </div>
                                             <div class="col-md-3">
                                                 <label for="kodeFasilitasTarif" class="form-label">kode Fasilitas
                                                     Tarif</label>
                                             ...
                                             <div class="col-md-3">
                                                 ...
                                                 <input type="text" class="form-control" id="kodeJenisPungutan2"
                                                     name="kodeJenisPungutan[]" value="{{ old('kodeJenisPungutan',"BM") }}"
                                                     >
                                             </div>
                                             <div class="col-md-3">
                                                 <label for="nilaiBayar" class="form-label">nilai Bayar</label>
                                             ...
                                             <div class="col-md-3">
                                                 ...
                                                 <input type="text" class="form-control" id="nilaiFasilitas2"
                                                     name="nilaiFasilitas[]" value="{{ old('nilaiFasilitas',0) }}"
                                                     >
                                             </div>
                                             <div class="col-md-3">
                                                 <label for="nilaiSudahDilunasi" class="form-label">nilai Sudah
                                             ...
                                             <div class="col-md-3">
                                                 ...
                                                 <input type="text" class="form-control" id="tarif2"
                                                     name="tarif[]" value="{{ old('tarif',7.5) }}" >
                                             </div>
                                             <div class="col-md-3">
                                                 <label for="tarifFasilitas" class="form-label">tarif Fasilitas</label>
                                     ...
                                     <h5 class="text-primary">Inputan Ke 2</h5>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="jumlahSatuan5"
                                                    name="jumlahSatuan[]" value="{{ old('jumlahSatuan',100) }}">
                                            </div>
                                            <div class="col-md-3">
                                                <label for="kodeFasilitasTarif" class="form-label">kode Fasilitas
                                                    Tarif</label>
                                                <input type="text" class="form-control" id="kodeFasilitasTarif3"
                                                    name="kodeFasilitasTarif[]" value="{{ old('kodeFasilitasTarif',"FT001") }}"
                                                    >
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="kodeSatuanBarang4"
                                                    name="kodeSatuanBarang[]" value="{{ old('kodeSatuanBarang',"PCS") }}"
                                                    >
                                            </div>
                                            <div class="col-md-3">
                                                <label for="kodeJenisPungutan" class="form-label">kode Jenis
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="nilaiBayar3"
                                                    name="nilaiBayar[]" value="{{ old('nilaiBayar', 5000.00) }}" >
                                            </div>
                                            <div class="col-md-3">
                                                <label for="nilaiFasilitas" class="form-label">nilai Fasilitas</label>
                                                <input type="text" class="form-control" id="nilaiFasilitas3"
                                                    name="nilaiFasilitas[]" value="{{ old('nilaiFasilitas',2000.00) }}"
                                                    >
                                            </div>
                                            <div class="col-md-3">
                                                <label for="nilaiSudahDilunasi" class="form-label">nilai Sudah
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="jumlahSatuan7"
                                                    name="jumlahSatuan[]" value="{{ old('jumlahSatuan',10) }}">
                                            </div>
                                            <div class="col-md-3">
                                                <label for="kodeFasilitasTarif" class="form-label">kode Fasilitas
                                                    Tarif</label>
