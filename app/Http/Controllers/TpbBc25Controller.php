...
class TpbBc25Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $fieldsToConvertInteger = [
            'jumlahKontainer', 'seri', 'bruto2','cif2','cif3','diskon','fob','hargaEkspor','hargaPenyerahan','isiPerKemasan','jumlahKemasan',
            'jumlahSatuan','jumlahSatuan2','jumlahSatuan3','jumlahSatuan4','jumlahSatuan5','jumlahSatuan6','jumlahSatuan7','jumlahSatuan8',
            ...
            'nilaiFasilitas','nilaiFasilitas2','nilaiFasilitas3','nilaiFasilitas4','nilaiFasilitas5','nilaiFasilitas','nilaiFasilitas2','nilaiFasilitas3',
            'nilaiFasilitas4','nilaiFasilitas5','tarif','tarif2','tarif3','tarif4','tarif5','nilaiBayar','nilaiBayar2','nilaiBayar3','nilaiBayar4','nilaiBayar5',
    ...
    // Struktur JSON yang sesuai dengan API eksternal
           $payload = [
                        ...
                        'barangTarif' => isset($validated['barangTarif']) ? $validated['barangTarif'] : [
                            [
                                "seriBarang" => $validated['seriBarang3'] ?? null,
                                "kodeJenisTarif" => $validated['kodeJenisTarif2'] ?? null,
                                "jumlahSatuan" => $validated['jumlahSatuan4'] ?? null,
                                "kodeFasilitasTarif" => $validated['kodeFasilitasTarif2'] ?? null,
                                "kodeSatuanBarang" => $validated['kodeSatuanBarang3'] ?? null,
                                "kodeJenisPungutan" => $validated['kodeJenisPungutan2'] ?? null,
                                "nilaiBayar" => $validated['nilaiBayar2'] ?? null,
                                "nilaiFasilitas" => $validated['nilaiFasilitas2'] ?? null,
                                "nilaiSudahDilunasi" => $validated['nilaiSudahDilunasi2'] ?? null,
                                "tarif" => $validated['tarif2'] ?? null,
                                "tarifFasilitas" => $validated['tarifFasilitas2'] ?? null,
                            ]
                        ],
                        'barangTarif' => isset($validated['barangTarif']) ? $validated['barangTarif'] : [
                            [
                                "seriBarang" => $validated['seriBarang4'] ?? null,
                                "kodeJenisTarif" => $validated['kodeJenisTarif3'] ?? null,
                                "jumlahSatuan" => $validated['jumlahSatuan5'] ?? null,
                                "kodeFasilitasTarif" => $validated['kodeFasilitasTarif3'] ?? null,
                                "kodeSatuanBarang" => $validated['kodeSatuanBarang4'] ?? null,
                                "kodeJenisPungutan" => $validated['kodeJenisPungutan3'] ?? null,
                                "nilaiBayar" => $validated['nilaiBayar3'] ?? null,
                                "nilaiFasilitas" => $validated['nilaiFasilitas3'] ?? null,
                                "nilaiSudahDilunasi" => $validated['nilaiSudahDilunasi3'] ?? null,
                                "tarif" => $validated['tarif3'] ?? null,
                                "tarifFasilitas" => $validated['tarifFasilitas3'] ?? null,
                            ]
                        ],
                        ...
                        'barangDokumen' => isset($validated['DokumenBarang']) ? $validated['DokumenBarang'] : [[
