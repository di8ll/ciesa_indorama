!(function () {
    ...
    function q(t, s) {
        ...
        if (
            (void 0 !== a.startView &&
                ((b = I(a.startView, b)), delete a.startView),
            b < p ? (b = p) : b > u && (b = u),
            b !== g && (n.startView = b),
            a.prevArrow)
        ) {
    ...
    class G extends X {
        ...
        setOptions(t) {
            ...
            void 0 !== t.showDaysOfWeek &&
                (t.showDaysOfWeek
                    ? (K(this.dow),
                      this.calendarWeeks && K(this.calendarWeeks.dow))
                    : (W(this.dow),
                        ...
                        function (e, t) {
                            ...
                            a
                                ...
                                : ne(
                                      e,
                                      1 === s
                                          ? Number(i.dataset.month)
                                          : Number(i.dataset.year)
                                  );
                        }.bind(null, e),
                    ],
                    [
    ...
    class me {
        constructor(e, t = {}, i) {
            ...
            (this.dates = fe(this, d) || []),
                r && (r.value = ue(this.dates, a));
